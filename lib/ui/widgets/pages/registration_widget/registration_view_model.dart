...
class RegistrationViewModel extends ChangeNotifier {
  ...
  Future<void> onRegistrationButtonPressed() async {
    ...
    try {
      ...
      await AppNavigator.navigateTo(RouteAction.pushAndRemoveUntil, AppNavigationRoutes.main);
      return;
    } on TimeoutException {
  ...
  void onRAuthButtonPressed() async {
    await AppNavigator.navigateTo(RouteAction.pushAndRemoveUntil, AppNavigationRoutes.auth);
  }
}
