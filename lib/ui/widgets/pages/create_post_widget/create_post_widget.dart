...
import 'package:social_net/ui/common/post_widget/post_carousel_indicator_widget.dart';
import 'package:social_net/ui/common/select_file_alert_dialog.dart';
import 'package:social_net/ui/widgets/pages/create_post_widget/create_post_view_model.dart';
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => showDialog<String>(
                      context: context,
                      builder: (BuildContext context) => SelectFileAlertDialog(
                  ...
                  const SizedBox(height: 20),
                  // if (post.attaches!.isNotEmpty) ImageCarouselWidget(),
